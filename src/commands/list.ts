...
export async function listCodeforcesProblems(): Promise<IProblem[]> {
    return globalState.getWithBackgroundRefresh<IProblem[]>("codeforcesProblems", async () => {
...
export async function listCodeforcesContests(): Promise<IContest[]> {
    return globalState.getWithBackgroundRefresh<IContest[]>("codeforcesContests", async () => {
...
export async function listCsesProblems(): Promise<Record<string, IProblem[]>> {
    return globalState.getWithBackgroundRefresh<Record<string, IProblem[]>>(
        "csesProblems",
        async () => {
