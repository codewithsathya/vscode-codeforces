...
const config = {
    ...
    output: {
        // the bundle is stored in the 'public' folder (check package.json), 📖 -> https://webpack.js.org/configuration/output/
        path: path.resolve(__dirname, 'public'),
        filename: './scripts/frontend.module.js',
            ...
            patterns: [
                {
                    ...
                    to: 'styles/codicon.css',
                },
                {
                    from: 'node_modules/@vscode/codicons/dist/codicon.ttf',
                    to: 'styles/codicon.ttf',
                },
            ],
        }),
    ],
